                                                                    ...
                                                                    <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                                        <tr>
                                                                            <td align="center" valign="top" bgcolor="'.$woocommerce_gift_coupon_bg_color_header.'" class="textContent">';
                                                                                if ($woocommerce_gift_coupon_show_logo > 0){
                                                                                    $email .= '<img src="'.$woocommerce_gift_coupon_logo.'" />';
                                                                                }
                                                                            $email .= '
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="center" valign="top" class="textContent" bgcolor="'.$woocommerce_gift_coupon_bg_color_title.'">
                                                                                ...
                                                                                <h2 style="text-transform:uppercase; color:#fff; text-align:center; font-size: 86px; font-family:Helvetica, Arial, sans-serif; font-weight:bold;display: block;margin: 0;"><strong>'.$data['symbol'].' '.$data['price'].' </strong></h2>
                                                                            </td>
                                                                        </tr>           
                                                                        <tr>
